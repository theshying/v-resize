(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["v-resize"] = factory();
	else
		root["v-resize"] = factory();
...
// CONCATENATED MODULE: ./src/v-resize.js
...
var vResize = {
  bind: function bind(el, _ref) {
    ...
    if (!isFunction(value)) {
      throw new Error("".concat(value, " must be a function"));
...
var createIframe = function createIframe() {
  ...
  iframe.style.height = '100%'; //插入到document中以后才能拿到contentWindow

  setTimeout(function () {
    var contentWindow = iframe.contentWindow;
    var modifiers = vResize.modifiers,
        el = vResize.el,
        value = vResize.value;
...
var emitElementSize = function emitElementSize() {
  var el = vResize.el,
      value = vResize.value;
...
var supportResizeObserver = function supportResizeObserver() {
...
/* harmony default export */ var v_resize = (vResize);
// CONCATENATED MODULE: ./src/index.js


var src_install = function install(Vue) {
  Vue.directive('resize', v_resize);
};
...
//# sourceMappingURL=v-resize.umd.js.map